...
# https://test-stand.gb.ru/api/posts c хедером, содержащим токен авторизации в параметре "X-Auth-Token". Для отображения постов другого пользователя
...
responce = requests.post(url="https://test-stand.gb.ru/gateway/login",
                         data={"username": "GB202306611b52", "password": "b61449c907"})
